...
import { CourseTask, deleteCourseTask, getTasksByCourse } from '@/action/course-task.action';
import { useEffect, useState } from 'react';
import toast from 'react-hot-toast';

interface CourseTaskListProps {
    courseId: string;
    onEdit: (task: CourseTask) => void;
}

export default function CourseTaskList({ courseId, onEdit }: CourseTaskListProps) {
